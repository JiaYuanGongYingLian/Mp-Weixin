!(function (e, n) {
  ...
  function c(n, e, i) {
    o.WeixinJSBridge
      ? WeixinJSBridge.invoke(n, r(e), function (e) {
          a(n, e, i)
        })
      : d(n, i)
  }
  ...
  function u(e) {
    I &&
      (o.WeixinJSBridge
        ? e()
        : t.addEventListener &&
          t.addEventListener('WeixinJSBridgeReady', e, !1))
  }
  ...
  if (!o.jWeixin) {
    var p = {
      ...
      var v = !(!h.match('mac') && !h.match('win'));
      var S = -1 != g.indexOf('wxdebugger');
      var I = -1 != g.indexOf('micromessenger');
      var y = -1 != g.indexOf('android');
      var _ = -1 != g.indexOf('iphone') || -1 != g.indexOf('ipad');
      var w = (O =
                      ...
                      !(function (e) {
                        if (
                          ...
                          ;(T.appId = M.appId),
                            ...
                            (T.preVerifyTime =
                              k.preVerifyEndTime - k.preVerifyStartTime),
                            C.getNetworkType({
                              isInnerInvoke: !0,
                              success: function (e) {
