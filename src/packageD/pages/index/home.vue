<template>
  <view>
    ...
    <view
      v-if="vuex_home_loading"
      class="u-border-bottom"
      v-for="(item, index) in vuex_latestConversationList[userinfo.id]"
    >
      <!-- u-border-bottom -->
      <u-swipe-action
        :options="options"
          ...
          <view class="body-item">
            <view style="position: relative">
              <u-lazy-load
                ...
                :image="vuex_nlist[item.targetId].avatar"
                threshold="300"
                img-mode="aspectFill"
              ></u-lazy-load>
              <u-lazy-load
                ...
                height="100"
                v-if="ingroup(item.targetId)"
                :image="vuex_grouplist[item.targetId].avatar"
                threshold="300"
                img-mode="aspectFill"
              ></u-lazy-load>
              <u-badge
            ...
            <view class="content">
              <view class="title">
                <view v-if="!ingroup(item.targetId)">
                  {{ vuex_nlist[item.targetId].nickname }}
                </view>
                <view v-if="ingroup(item.targetId)">
                  {{ vuex_grouplist[item.targetId].name }}
                </view>
              </view>
