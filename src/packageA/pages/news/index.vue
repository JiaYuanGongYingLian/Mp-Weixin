...
const dynamicList = reactive({
  list: [
    {
      title: '家长如何应对孩子沉迷手机问题？',
      content: 'https://mp.weixin.qq.com/s/vonaKfetVP6i9z1Pbkwuww',
      coverImage: 'https://mp.weixin.qq.com/s/vonaKfetVP6i9z1Pbkwuww',
      url: 'https://mp.weixin.qq.com/s/vonaKfetVP6i9z1Pbkwuww'
    }
  ],
  loading: true,
  pageIndex: 1,
