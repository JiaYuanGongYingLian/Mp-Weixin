 ...
 * @LastEditTime: 2023-07-22 04:22:58
...
<template>
  <view class="wrapper">
    <view class="videoList">
      <view class="video-item" v-for="(item, index) in videoList.list" :key="item.id">
        <u-image width="100%" height="360rpx" :src="getImgFullPath(item.previewImage)" @click="toView(index)"></u-image>
        <view class="like">
